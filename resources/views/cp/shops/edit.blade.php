...
@section('content')
    <div class="page-body" dir="rtl">
        ...
        <form class="form-horizontal" method="post"
              action="{{route('updateShop')}}" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="modal-body">
                <input type="hidden" name="model_id" value="{{$shop->id}}">


                <div class="form-group row">
                    <label class="col-lg-12 control-label text-lg-right" for="textinput">الاسم </label>
                    <div class="col-lg-12">
                        <input name="name" type="text" placeholder="الاسم" value="{{$shop->name}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب ادخاله')">
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-lg-12">
                        <input id="inputName1" name="description" type="text" value="{{$shop->description}}" placeholder="الوصف " class="form-control btn-square" for="textinput"  required oninvalid="this.setCustomValidity('هذا الحقل مطلوب ادخاله')">
                        <div class="invalid-feedback">هذا الحقل مطلوب ادخاله .</div>
                    </div>
                </div>

                <div class="form-group row ">
                    <label class="col-lg-12 control-label text-lg-right"  for="validationCustom04">الدولة </label>
                    <div class="col-lg-12">
                        <select class="form-control btn-square" name="country_id" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب ادخاله')">
                            @foreach($countries as $country)
                                <option  value="{{$country->id}}" {{$country->id == $shop->country_id ? "selected" : ""}}>{{$country->name}}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">هذا الحقل مطلوب ادخاله .</div>
                    </div>
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-lg-12">
                        <input id="inputName1" name="phone" type="text" value="{{$shop->phone}}" placeholder="الموبايل " class="form-control btn-square" for="textinput"  required oninvalid="this.setCustomValidity('هذا الحقل مطلوب ادخاله')">
                        <div class="invalid-feedback">هذا الحقل مطلوب ادخاله .</div>
                    </div>
                </div>
                <div class="form-group row ">
                    ...
                    <div class="col-lg-12">
                        <input id="inputName1" name="email" type="text"  value="{{$shop->email}}" placeholder="البريد الالكتروني " class="form-control btn-square" for="textinput"  required oninvalid="this.setCustomValidity('هذا الحقل مطلوب ادخاله')">
                        <div class="invalid-feedback">هذا الحقل مطلوب ادخاله .</div>
                    </div>
                </div>
                <div class="form-group row ">
                ...
                <div class="form-group row ">
                    <label class="col-lg-12 control-label text-lg-right"  for="validationCustom04">القسم</label>
                    <div class="col-lg-12">
                ...
                <img src="{{$shop->image}}" width="50px" height="50px"></img>
                ...
                <img src="{{$shop->cover_image}}" width="50px" height="50px"></img>
