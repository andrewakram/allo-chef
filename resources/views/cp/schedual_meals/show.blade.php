            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <input name="name" type="text" placeholder="الإسم بالعربي" value="{{$meal->lable_ar}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب إدخاله')">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <input name="name" type="text" placeholder="العنوان بالانجليزي" value="{{$meal->lable_en}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب إدخاله')">
                            <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <input name="name" type="text" placeholder="الإسم بالعربي" value="{{$meal->price_before}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب إدخاله')">
                            <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <input name="name" type="text" placeholder="العنوان بالانجليزي" value="{{$meal->price_after}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب إدخاله')">
                            <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <input name="name" type="text" placeholder="الإسم بالعربي" value="{{$meal->points}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب إدخاله')">
                            <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <input name="name" type="text" placeholder="العنوان بالانجليزي" value="{{$meal->publish_date}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب إدخاله')">
                            <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>
                        </div>
                    </div>
                </div>
                ...
                <hr>
                <br>
                <h1 class="text-lg-center">تفاصيل الطبخة</h1>
                <div class="form-group row">
                    <label class="col-lg-12 control-label text-lg-right" for="textinput">الإسم بالعربي</label>
                    <div class="col-lg-12">
                        <input name="name" type="text" placeholder="الإسم بالعربي" value="{{$meal->meal->name_ar}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب إدخاله')">
                        <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-12">
                        <input name="name" type="text" placeholder="الإسم بالانجليزي" value="{{$meal->meal->name_en}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب إدخاله')">
                        <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <input name="name" type="text"  value="{{$meal->meal->price}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب إدخاله')">
                            <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <input name="name" type="text"  value="{{$meal->meal->points}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب إدخاله')">
                            <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <input name="name" type="text"  value="{{$meal->meal->persons}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب إدخاله')">
                            <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <input name="name" type="text"  value="{{$meal->meal->grams}}" class="form-control btn-square" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب إدخاله')">
                            <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-lg-12">
                        <textarea class="form-control btn-square">{{$meal->meal->description_ar}}</textarea>
...
{{--                        <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>--}}
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-lg-12">
                        <textarea class="form-control btn-square">{{$meal->meal->description_en}}</textarea>
...
{{--                        <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>--}}
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-lg-12">
                        <textarea class="form-control btn-square">{{$meal->meal->method_ar}}</textarea>
...
{{--                        <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>--}}
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-lg-12">
                        <textarea class="form-control btn-square">{{$meal->meal->method_en}}</textarea>
...
{{--                        <div class="invalid-feedback">هذا الحقل مطلوب إدخاله .</div>--}}
                ...
                <div class="form-group row ">
                    ...
                    @foreach($meal->meal->meal_ingredients as $ingredient)
                        <div class="col-lg-6">
                            <label class="col-lg-12 control-label text-lg-right"  for="validationCustom04">الوصف بالعربي</label>
                            <div class="col-lg-12">
                ...
                @foreach($meal->meal->images as $image)
