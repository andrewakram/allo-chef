                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div style="float: left">
                            @if(auth()->user()->hasPermissionTo('اضافة مفقودات'))
...
{{--                                    <td>{{$c->is_captin == 1 ? "خاص بالسائق" : "خاص بالمستخدم"}}</td>--}}
                                    ...
                                    <td>
                                        @if(auth()->user()->hasPermissionTo('تعديل مفقودات'))
                                        <button title="تعديل" type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit_{{$c->id}}">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                        @endif

                                        @if(auth()->user()->hasPermissionTo('حذف مفقودات'))
                                        <a href="{{route('deleteLost',$c->id)}}" data-original-title="" title="">
                                    ...
                                    <div class="modal fade" id="edit_{{$c->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form class="form-horizontal" method="post" action="{{route('editLost')}}" enctype="multipart/form-data">
                                                    {{csrf_field()}}
                                                    <div class="modal-body">
                                                        <input type="hidden" name="lost_id" value="{{$c->id}}">


                                                        <div class="form-group row ">
                                                            <label class="col-lg-12 control-label text-lg-right" for="textinput">النص بالعربية</label>
                                                            <div class="col-lg-12">
                                                                <input name="ar_lost" class="form-control" type="text" value="{{$c->ar_lost}}" >
                                                            </div>
                                                        </div>
{{--                                                        <div class="form-group row ">--}}
{{--                                                            <label class="col-lg-12 control-label text-lg-right" for="textinput">النص بالانجليزية</label>--}}
{{--                                                            <div class="col-lg-12">--}}
{{--                                                                <input name="en_lost" class="form-control" type="text" value="{{$c->en_lost}}" >--}}
{{--                                                            </div>--}}
{{--                                                        </div>--}}
{{--                                                        <div class="form-group row ">--}}
    ...
    <div class="modal fade" id="subCat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal needs-validation was-validated" method="post" action="{{route('losts.store')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        ...
                        <div class="form-group row ">
                            <label class="col-lg-12 control-label text-lg-right" for="textinput">النص بالعربية</label>
                            <div class="col-lg-12">
                                <input name="ar_lost" class="form-control digits" type="text" required>
...
{{--                            <label class="col-lg-12 control-label text-lg-right" for="textinput">النص بالانجليزية</label>--}}
{{--                            <div class="col-lg-12">--}}
{{--                                <input name="en_lost" class="form-control digits" type="text" required>--}}
{{--                                <div class="invalid-feedback">هذا الحقل مطلوب ادخاله .</div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="form-group row ">--}}
