                    ...
                    <div class="col">
                        <div class="page-header-right">
                            ...
                            <h3>
                                ...
                                الرحلات
                                 ({{sizeof($trips)}})
                                <a href="{{asset('admin/finished-trips')}}" class="btn btn-warning"><span>الرحلات المنتهية</span></a>
                                <a href="{{asset('admin/unfinished-trips')}}" class="btn btn-info"><span>الرحلات غير منتهية</span></a>
                                <a href="{{asset('admin/cancelled-trips')}}" class="btn btn-danger"><span>الرحلات  الملغية</span></a>
                            </h3>
                            {{--<ol class="breadcrumb">
