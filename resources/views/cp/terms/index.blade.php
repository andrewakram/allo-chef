...
{{--                                                          placeholder="النص بالعربية" required--}}
{{--                                                          oninvalid="this.setCustomValidity('هذا الحقل مطلوب ادخاله')">{{$c->term_ar}}</textarea>--}}
                                            </td>
                                            <td>{{$c->term_en}}
{{--                                                <textarea class="form-control" name="body_en" rows="15" placeholder="النص بالنجليزية" dir="ltr" required oninvalid="this.setCustomValidity('هذا الحقل مطلوب ادخاله')">{{$c->term_en}}</textarea>--}}
                                            ...
                                            <td>
                                                @if(auth()->user()->hasPermissionTo('تعديل الشروط و الأحكام'))
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">تعديل الشروط
                                                                و الاحكام</h5>
                                                        ...
                                                        <form class="form-horizontal" method="post"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group row {{ $errors->has('ar_name') ? ' has-error' : '' }}">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <textarea class="form-control" name="term_ar"
                                                                                  rows="10"
                                                                                  placeholder="النص بالعربية">{{$c->term_ar}}</textarea>
                                                                    </div>
                                                                </div>
