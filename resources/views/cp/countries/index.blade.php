                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group row {{ $errors->has('ar_name') ? ' has-error' : '' }}">
                                                                    <label class="col-lg-12 control-label text-lg-right"
                                                                           for="textinput">الاسم بالعربية</label>
                                                                    <div class="col-lg-12">
                                                                ...
                                                                <div class="form-group row {{ $errors->has('en_name') ? ' has-error' : '' }}">
                                                                    <label class="col-lg-12 control-label text-lg-right"
                                                                           for="textinput">الاسم بالنجليزية</label>
                                                                    <div class="col-lg-12">
                                                                        <input name="name_en" type="text"
                                                                               placeholder="الاسم بالنجليزية"
                                                                               class="form-control btn-square"
...
{{--                                                                    <label class="col-lg-12 control-label text-lg-right"--}}
{{--                                                                           for="textinput"> العملة</label>--}}
{{--                                                                    <div class="col-lg-12">--}}
{{--                                                                        <input id="name" name="currency" type="text"--}}
{{--                                                                               placeholder="العملة"--}}
{{--                                                                               class="form-control btn-square"--}}
{{--                                                                               value="{{$c->currency}}">--}}
{{--                                                                    </div>--}}
{{--                                                                </div>--}}
                                                                ...
                                                                <div class="form-group row {{ $errors->has('code') ? ' has-error' : '' }}">
                                                                    <label class="col-lg-12 control-label text-lg-right"
                                                                           for="textinput">كود الدولة</label>
                                                                    <div class="col-lg-12">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal needs-validation was-validated" method="post"
                      action="{{route('countriess.store')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-12 control-label text-lg-right" for="textinput"> العملة</label>
                            <div class="col-lg-12">
                                <input id="name" name="currency" type="text" placeholder=" العملة"
                                       class="form-control btn-square">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12">
                                <input id="name" name="code" type="text" placeholder="كود الدولة"
                                       class="form-control btn-square" required
                                       oninvalid="this.setCustomValidity('هذا الحقل مطلوب ادخاله')">
                                <div class="invalid-feedback">هذا الحقل مطلوب ادخاله .</div>
                            </div>
