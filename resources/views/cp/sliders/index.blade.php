                            ...
                            @foreach($offers as $c)
                                <tr id="main_cat_{{$c->id}}" onclick="myFunction({{$c->id}})">
                                    ...
                                    <td>
                                        ...
                                        @endif
                                            @if(auth()->user()->hasPermissionTo('لوحة التحكم'))
                                                <a href="{{route('deleteSlider',$c->id)}}" data-original-title="" title="">
                                    ...
                                    <div class="modal fade" id="edit_{{$c->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form class="form-horizontal" method="post" action="{{route('editSlider')}}" enctype="multipart/form-data">
                                                    {{csrf_field()}}
    ...
    <div class="modal fade" id="subCat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal needs-validation was-validated" method="post" action="{{route('sliders-store')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
