...
return
    [
        ...
        'email_not_exist' =>
            [
                'ar' => 'البريد الالكتروني غير مسجل لدينا',
        ...
        'email_checked' =>
            [
                'ar' => 'تم التحقق من البريد الاكتروني , يرجي ادخال الرقم السرى',
                'en' => 'Email verified ,please type your password',
            ],
        'phone_exist' =>
            [
        ...
        'delegate_unsubscribed' =>
            [
                'ar' => 'تم الغاء تسجيلك لهذا المتجر',
        ...
        'max_offers_limit' =>
            [
                'ar' => 'لقد وصلت للحد الاقصي للعروض',
                'en' => 'You reached max offers limit',
            ],
        ...
        'user_cancel_order' =>
            [
                'ar' => 'تم الغاء الطلب من العميل ',
                'en' => ' User cancelled order.',
            ],
        'meal_liked' =>
            [
                'ar' => 'تم اضافة الوجبة الي المفضلة',
                'en' => 'Meal added to favourite.',
            ],
        'meal_disliked' =>
            [
                'ar' => 'تم ازالة الوجبة من المفضلة',
                'en' => 'Meal removed to favourite.',
            ],
        'low_cost' =>
            [
                'ar' => 'ليس لديك رصيد كافي',
                'en' => 'Don\'t have enough credit.',
            ],
        'subscription_expire' =>
            [
                'ar' => 'انتهاء صلاحية الباقة , يرجي التجديد',
                'en' => 'Subscription expired , Please renew',
            ],
        'please_login_first' =>
            [
                'ar' => 'يرجي تسجيل الدخول اولا',
                'en' => 'please login first',
            ],
        'order_not_found' =>
            [
                'ar' => 'رقم الطلب غير صحيح',
                'en' => 'order number not true',
            ],
        'order_payed_cash' =>
            [
                'ar' => 'تم إنشاء الطلب بنجاح وسيتم الدفع عند الإستلام',
                'en' => 'order created successfully and payment will be in-door',
            ],
        'please_subscribe' =>
            [
                'ar' => 'الرجاء الإشتراك في إحدي الباقات',
                'en' => 'please subscribe to one of the packages',
            ],
    ];
